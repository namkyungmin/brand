		...
		<div class="row" style="background:#fff;">
                  <table id="body_list" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center">A/S문의</td>
                        <td class="text-center"><a href="as_detail?as_id=${data.asId}">${data.title }</a></td>
                        <td class="text-center">${data.userId }</td>
                        <td class="text-center">${data.regTime}</td>
                        <td class="text-center">${data.replyTime}</td>
                        <td class="text-center">${data.status }</td>
                        <td class="text-center"><p class="ellipsis" title="${data.comment }">${data.comment }</p></td>
                    </tr>
                    </c:forEach>
