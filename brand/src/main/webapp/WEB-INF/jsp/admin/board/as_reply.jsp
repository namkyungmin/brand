        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">A/S문의관리</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		...
		<div class="box" style="background:#fff;">
                <div class="box-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th><span class="text-required">*</span> 동호수</th>
                        <td>
	                        ${data.parcelAddress }   
						</td>
                      </tr>                              
                ...
                <input type="hidden" name="asId" id="asId" value="${data.asId}" />                		            
				...
				<div class="card card-default">
		          ...
		          <!-- /.card-header -->
		          <div class="card-body" style="display: block;height:400px;width:100%;">
		            <div class="row">

		                <table id="detail1" class="table table-bordered table-bordered-border"  style="width:100%;">
	                     <colgroup>
	                      <col width="15%">
	                      <col width="*">
	                     </colgroup>
