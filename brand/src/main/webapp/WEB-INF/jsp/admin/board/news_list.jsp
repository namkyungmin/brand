		...
		<div class="row" style="background:#fff;">
                  <table id="body_list" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="news_detail?news_id=${data.newsId}">${data.title }</a></td>
                        <td class="text-center">${data.adminId }</td>
                        <td class="text-center">${data.displayDate }</td>
                        <td class="text-center">${data.regTime}</td>
                        <td class="text-center">${data.readCnt}</td>
