		...
		<div class="row" style="background:#fff;">
                  <table id="body_list" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center">${data.popupType=='ALL'?"PC/MOBILE":"" } ${data.popupType!='ALL'?data.popupType:"" }</td>
                        <td class="text-center"><a href="popup_detail?popup_id=${data.popupId}">${data.title }</a></td>
