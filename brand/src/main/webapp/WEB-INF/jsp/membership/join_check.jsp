            ...
            <div id="contents">
                ...
                <div class="tab_nav">
					<ul>
						...
						<li class="on"><a href="javascript:;;">STEP 2. 본인 인증</a></li>
                ...
                <div class="section sec1">
                    <div class="info_area">
                        <div class="inner">
                            <div class="text_wrap">
                                <p class="txt1">안전한 회원가입을 위한 본인인증 단계입니다.<br> 원하시는 인증방법을 선택해 주세요.</p>
                                <p class="txt2">실명인증은 아이핀, 휴대폰 중 소지하고 계신 한 가지를 선택하여<br>하실 수 있습니다. 본인인증 시 제공되는 정보는 해당 기관에서<br>직접 수집하며, 인증 이외의 용도로 이용 또는 저장되지 않습니다.</p>
                            </div>
