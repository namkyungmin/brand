...
<body>
    <div id="wrap" class="wrap sub estate list complete">
        ...
        <div id="container"> 
            ...
            <div id="contents">
                <div class="section">
                    <div class="search_box">
                        <div class="search_wrap">
                            <div class="input_wrap">
                                ...
                                <input type="hidden" name="parcelStage" id="parcelStage" value="분양완료" />
                                <a href="javascript:;;" class="btn_search" id="searchBtn">검색</a>
                            </div>
                            <div class="type_box">
                                <div class="check_area search_area">
                                    <p class="tit">지역별 검색</p>
                                ...
                                <div class="check_area search_type">
                                    <p class="tit">유형별 검색</p>
                                    <div class="check_wrap">
                                        <span class="checked check_all">
                        ...
                        <a href="#" class="search_close">상세검색 <span>열기</span></a>
                    </div>     
                    <div class="parcel_wrap" id="parcel_body">
                     <c:forEach var="data" items="${list}"  varStatus="status">
                        <div class="parcel_item">
                            <div class="btn_area">
                                ...
                                <a href="javascript:;;" id="favoriteBtn" data-parcelId="${data.parcelId }" style="display:none" class="btn_favor ${data.favorite!=null?"on":"" }"></a>
                            </div>
                    ...
                    <c:if test="${listCnt  > 6}">
                    <div class="btn_wrap">
                        <a href="javascript:void(0);" class="basic_btn more"  id="moreBtn">
                            <span>더 보기</span>
                        </a>
                    </div>
                    </c:if>
    ...
    <script src="/resources/mobile/js/parcel.js"></script>
    <script>
