        ...
        <div id="container">
            ...
            <div id="contents">
                <div class="section sec1">
                    ...
                    <p class="bottom_txt">자세한 사항은 <span>KB국민은행 또는<br> 한국감정원 청약홈</span>을 통해 확인 하실 수 있습니다.</p>
                    <div class="btn_wrap">
                        <a href="https://oland.kbstar.com/quics?page=ohsubs" class="basic_btn type02" target="_blank"><span>KB국민은행</span></a>
                        <a href="https://www.applyhome.co.kr/co/coa/selectMainView.do" class="basic_btn" target="_blank"><span>한국감정원 청약홈</span></a>
                    </div>
                </div>
            </div>
        </div>
