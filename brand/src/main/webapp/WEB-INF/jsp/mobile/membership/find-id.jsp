...
<%
	...
	*/
	...
	String sReturnURL	= url+"/plugin/ipin_process.jsp?mode=find-id";
...
<%
    ...
    String sReturnUrl = url+"/plugin/checkplus_success.jsp?mode=find-id";      // 성공시 이동될 URL
    String sErrorUrl = url+"/plugin/checkplus_fail.jsp?mode=find-id";          // 실패시 이동될 URL    
...
<title>본인 인증 | 아이디 찾기 | 경남아너스빌</title>
	<script>
        ...
        <div id="container">
            ...
            <div id="contents">
                <div class="section sec1">
                    <div class="box_wrap">
                        <p class="txt1">실명인증은 아이핀, 휴대폰 중 소지하고 계신 한 가지를 선택하여 하실 수 있습니다.</p>
                        <p class="txt2">본인 인증 시 제공되는 정보는 해당 기관에서 직접 수집하며, 인증 이외의 용도로 이용 또는 저장되지 않습니다.</p>
                        <div class="btn_wrap">
								<form name="form_ipin" method="post">
									...
									<input type="hidden" name="mode" value="find-id">
								</form>
                    ...
                    <span class="sec_footer">비밀번호를 찾으시나요? <a href="/membership/find-password">비밀번호 찾기</a></span>
                </div>
            </div>
        </div>
