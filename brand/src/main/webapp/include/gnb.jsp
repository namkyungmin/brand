            ...
            <ul class="member_wrap member">
             ...
             <div class="sns_wrap">
                <div class="inner">
                    ...
                    <div class="sns">
                        <span>
                            <a href="https://youtu.be/HpP6siQh9NM" class="youtube" target="_blank"></a>
                            <!-- <a href="javascripot:void(0);" class="facebook"></a>
                            <a href="javascripot:void(0);" class="kakao"></a> -->
                        </span>
                    </div>
                </div>
            </div>
